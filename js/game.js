let GameManager = {
    ...
    setGameStart: function(classType) {
        ...
        // --- FIX: Clear old enemy card when starting a new trial ---
    ...
    setFight: function() {
        ...
        if (!enemyContainer) {
            console.error("Critical Error: .enemy container not found in DOM.");
            return;
        }

        // Always clear before generating a new enemy
        ...
        enemy.state = { bleed: 0, stacks: 0, tempBuff: 0, theftCap: 0, isDefending: false, mpGainFromDmg: false };
